...
<template>
  <section class="ai-recognition">
    ...
    <div v-if="!displayEvents.length" class="ai-recognition__empty">暂无识别记录</div>
...
/** 占位数据，后续由父组件传入接口结果即可覆盖 */
const DEFAULT_EVENTS = [
  {
    key: "ai1",
    type: "人脸预警",
    time: "2025-8-12 19:31:45",
    image: "",
    result: "识别到人体：1",
    coord: "经纬度",
  },
...
const displayEvents = computed(() =>
  Array.isArray(props.events) ? props.events : DEFAULT_EVENTS,
);
</script>
