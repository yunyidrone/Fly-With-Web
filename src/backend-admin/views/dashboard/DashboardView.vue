  ...
  <div class="dashboard-view">
    ...
    <div class="page-card dashboard-view__table">
      <div class="page-toolbar">
        <div class="page-toolbar__title">设备状态明�?/div>
        <div class="page-toolbar__actions">
          <el-tag type="info" effect="plain">�?{{ pollSeconds }}s 自动刷新</el-tag>
      ...
      <el-table v-loading="loading" :data="records" stripe border>
        ...
        <el-table-column prop="orgName" label="所属单�? min-width="120" />
        ...
        <el-table-column prop="lastOnlineAt" label="最近在�? min-width="160" />
      </el-table>
    </div>
  </div>
</template>
...
const statCards = [
  ...
  { key: "lowBattery", label: "低电�?, color: "#f56c6c" },
  { key: "escorting", label: "伴飞�?, color: "#e6a23c" },
];
